...
import com.example.zipin.bluetoothClientServer.common.logger.Log;
...
public class BluetoothChatService {
    ...
    private  class  ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            //byte[] buffer = new byte[1024]; not hier but ib while body
            ...
            while (true) {
                try {
                    ...
                    if (containsEndByte(buffer)) {
                        mHandler.obtainMessage(Constants.MESSAGE_READ_END, bytes, -1, sb.toString())
                                .sendToTarget();
