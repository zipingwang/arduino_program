...
void loop(){   
   ...
   //set turn motor to start position
    ...
    ShiftMotor.goSteps(76, false, 4, 6, 5, 7, 1, motorSpeedHuataiBackword, noStopPin);
    ShiftMotor.sleepMotor();
    delay(1000);
    
    //negative anticclockwise
    //set turn motor to pull out salt position
    ShiftMotor.goSteps(-330, false, 0, 1, 2, 3, 1, motorSpeed28, noStopPin);
    ShiftMotor.sleepMotor();
    delay(1000); 
    ...
    ShiftMotor.sleepMotor();
    delay(3000);
    //------end region take salt
    
    //------region take total
    //positive clockwise
    //set final move motor to start position
    ShiftMotor.goSteps(500, false, 0, 1, 2, 3, 2, motorSpeed28, stopPinTotal);
    ShiftMotor.sleepMotor();
    delay(1000);
    ...
    //set final move motor to start position
    ShiftMotor.goSteps(-200, false, 0, 1, 2, 3, 2,  motorSpeed28, noStopPin);
    ShiftMotor.sleepMotor();
    delay(1000);
    ...
    //negative anticlockwise
    //final turn motor 120 degree
    ShiftMotor.goSteps(-330, false, 4, 5, 6, 7, 2, motorSpeed28, noStopPin);
    ShiftMotor.sleepMotor();
    delay(1000);
