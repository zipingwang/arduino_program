...
int motorSpeed28 =2000; //1200;  //variable to set stepper speed //800 is smallest value can set for 8 steps
...
int pinCookingPlatePowerPlus=46;
int pinCookingPlatePowerMin=48;
