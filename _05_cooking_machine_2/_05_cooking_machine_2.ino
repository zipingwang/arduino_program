...
MultiStepperMotorDriver stepperMotorDriver= MultiStepperMotorDriver(A4, A5, A3, 2, false, motorSpeed28);
Motor motorSalt = Motor(2, false, false, NO_STOP_PIN, 512);  
...
void setup() {
  ...
  //------ region set motor begin state
   ...
   // shiftMotor.sleepMotor();
	...
	stepperMotorDriver.driveMotors(motors, 3);
